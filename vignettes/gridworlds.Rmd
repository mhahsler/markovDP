---
title: "Gridworlds in Package mdp"
author: "Michael Hahsler"
bibliography: references.bib
vignette: >
  %\VignetteIndexEntry{Gridworlds in Package mdp}
...
work.
The R package **mdp** provides a set of helper functions starting with the 
prefix `gridworld_`
to make defining and experimenting with gridworlds easy. 

Gridworlds can also easiliy be extended to Partially Observable Decision Problems (POMDPs)
using the R package **pomdp** [@Hahsler2024] provides a set of 
