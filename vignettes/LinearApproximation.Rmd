...
Now, we can solve the model. Both, alpha and epsilon follow an exponential schedule.
Epsilon used for the \eqn{\epsilon}-greedy behavior policy starts at 1 and decays
by a factor of 0.1 per episode. The step size alpha starts at 0.2 and also decays bu
0.1 per episode.
