...
| $v_\pi(s), v_*(s)$ | | value of state $s$ under policy  $\pi$ or under the optimal policy |  
| $V$ | vector `V` | the tabular estimate of $v_\pi(s)$ or $v_*(s)$ | 
...
absorbing states and the wall is an unreachable state.
